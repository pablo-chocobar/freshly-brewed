...
function ShowcaseCard(props) {
    ...
    useEffect(() => {
        setTimeout(() => {
            props.theme == "light" ?  navigate("/Projectlight") :  navigate("/Projectdark") 
        } , 3000);
    } , [])


    return (
        <div className='flex rounded-3xl max-w-1/3 mx-10 sm:mx-0 sm:min-w-max sm:max-w-[80%] flex-col bg-gradient-to-r from-primary to-secondary'>
            <div className='flex flex-col justify-center text-center mx-8 items-center max-w-[570px] pt-8'>
                ...
                <button onClick={CTAonclick} className='rounded-lg my-10 bg-background text-content1  max-w-1/4 sm:max-w-max font-poppins text-3xl leading-8 font-medium px-5 py-3'>
                    Get Started
                </button>
            </div>
